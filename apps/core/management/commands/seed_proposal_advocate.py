...
RECS_LEAD = (
    'Лендінг адвокатських послуг на Django / HTMX: '
    'каталог практик, заявка в Telegram, PageSpeed 95+.'
)
...
ARCH_NODES = [
    ...
    {'order': 1, 'title': 'Practices', 'caption': 'Цивільне · бізнес', 'is_accent': True},
...
MODULES = [
    {
        ...
        'title': 'Офер і докази',
        'description': (
            'Позиціонування, досвід, соціальні докази і адресні кнопки запису. '
            'Відвідувач розуміє, з чим адвокат береться, до форми.'
        ),
    },
    {
        'number': 2,
...
PACKAGES = [
    ...
    },
    {
        ...
        'name': 'Сайт + ADS',
        'scope': (
            'Усе з Базового плюс Google Ads під юридичну тематику: '
...
SPECS = [
    {
        ...
        'body': (
            'Хто адвокат, досвід, ліцензія і термінова правова допомога. '
            'Запис — на першому екрані.'
        ),
    },
    {
        'kind': ProposalSpec.Kind.SPEC,
        ...
        'body': (
            'Цивільне, кримінальне, бізнес і податки, сімейне право. '
            'Картка практики з вартістю, без перезавантаження сторінки.'
        ),
    },
    {
        'kind': ProposalSpec.Kind.SPEC,
        'order': 2,
        'title': 'Форма правового аналізу',
        'body': (
            'Клієнт коротко описує ситуацію і прикріплює документи. '
            'Заявка йде адвокату, а не лишається в формі.'
        ),
    },
    {
        'kind': ProposalSpec.Kind.SPEC,
        'order': 3,
        'title': 'Кейси і конфіденційність',
        'body': (
            'Виграні спори, сертифікати, відгуки довірителів '
            'і явні правила конфіденційності.'
        ),
    },
    {
...
TITLE = 'Лендінг адвокатських послуг під ключ'
LEAD = (
    'Сторінка, яка перетворює рекламний клік на запис: '
    'каталог практик, докази і заявка адвокату.'
)

INTRO_HTML = """
<p><strong>PrometeyLabs</strong> збирає лендінг лідогенерації для юридичної практики: офер, довіра і форма на одному швидкому екрані.</p>
...
<ul>
<li><strong>PageSpeed 95+</strong> — відвідувач лишається, ціна кліка в Google Ads не роздувається очікуванням.</li>
<li><strong>HTMX</strong> — каталог практик і форма працюють без повного перезавантаження.</li>
</ul>
""".strip()
...
class Command(BaseCommand):
    ...
    def _seed_rows(self):
        proposal, created = Proposal.objects.update_or_create(
            slug=SLUG,
            defaults={
                'client_name': 'Адвокатські послуги',
                'title': TITLE,
