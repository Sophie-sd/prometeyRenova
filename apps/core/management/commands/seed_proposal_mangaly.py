...
GUARANTEE_HTML = """
<p>Сайт пишеться з нуля на чистому коді, без громіздкого конструктора. Пожиттєва гарантія на працездатність ядра протягом життя ресурсу.</p>
<p>Оплата 50/50: старт розробки, потім фінал після тестування і перед релізом.</p>
""".strip()
