                ...
                "items": [
                    {
                        "title": _("Заявки"),
                        "icon": "inbox",
                        "link": reverse_lazy("admin:core_formsubmission_changelist"),
...
MIDDLEWARE = [
    ...
    'apps.core.middleware.NoIndexPrivatePathsMiddleware',
...
if DEBUG:
    ...
    WHITENOISE_SKIP_COMPRESS_EXTENSIONS = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'woff', 'woff2', 'zip', 'gz', 'bz2']
